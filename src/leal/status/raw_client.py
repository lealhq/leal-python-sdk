...
class RawStatusClient:
    ...
    def check(self, *, request_options: typing.Optional[RequestOptions] = None) -> HttpResponse[CheckStatusResponse]:
        """
        ...
        Returns
        -------
        HttpResponse[CheckStatusResponse]
            The service status
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    CheckStatusResponse,
                    parse_obj_as(
                        type_=CheckStatusResponse,  # type: ignore
...
class AsyncRawStatusClient:
    ...
    ) -> AsyncHttpResponse[CheckStatusResponse]:
        """
        Returns the status of the API. No authentication required.
